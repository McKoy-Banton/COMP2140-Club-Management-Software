...
if ($_SERVER["REQUEST_METHOD"]==="POST")
{
    ...
    $sql= sprintf("SELECT * FROM student WHERE id_number  = '%s'", 
    ...
    if($user)
    {
       if(password_verify($_POST["password"], $user["student_password"]))
       {
           $isinvalid=false; 
           session_start();
           $_SESSION["user_id"]=$user["id_number"];

           header("Location: club member page.php");
           exit;
...
<body>
  <div class="login-container">
    <h2>Login Page For Club Member</h2>
